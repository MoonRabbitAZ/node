...
use moonrabbit_scale_codec::{Encode, Decode, CompactAs};
...
#[cfg(feature = "std")]
use moonrabbit_util_mem::MallocSizeOf;

use moonrabbit_core_primitives::{Hash, OutboundHrmpMessage};

/// Block number type used by the relay chain.
pub use moonrabbit_core_primitives::BlockNumber as RelayChainBlockNumber;
...
impl<'a> moonrabbit_scale_codec::Input for TrailingZeroInput<'a> {
