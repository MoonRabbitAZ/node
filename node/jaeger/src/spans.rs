...
//! moonrabbit Jaeger span definitions.
//!
//! ```rust
//! # use moonrabbit_primitives::v1::{CandidateHash, Hash};
//! # fn main() {
...
//! 		// add a `Stage` for [`dot-jaeger`](https://github.com/moonRabbitAZ/dot-jaeger)
...
use moonrabbit_primitives::v1::{BlakeTwo256, CandidateHash, Hash, HashT, Id as ParaId, ValidatorIndex};
...
pub enum Stage {
	...
	// (https://moonrabbit.network/the-path-of-a-parachain-block/)
	// see [issue](https://github.com/moonRabbitAZ/moonrabbit/issues/2389)
}
