...
//!
//! Unlike the `moonrabbit-primitives` crate, these primitives are only used on the node-side,
...
use moonrabbit_primitives::v1::{BlakeTwo256, CandidateCommitments, CandidateHash, CollatorPair, CommittedCandidateReceipt, CompactStatement, EncodeAs, Hash, HashT, HeadData, Id as ParaId, OutboundHrmpMessage, PersistedValidationData, Signed, UncheckedSigned, UpwardMessage, ValidationCode, ValidatorIndex};
pub use moonrabbit_parachain::primitives::BlockData;
...
///
/// - does not contain the erasure root; that's computed at the moonrabbit level, not at Cumulus
/// - contains a proof of validity.
#[derive(Clone, Encode, Decode)]
pub struct Collation<BlockNumber = moonrabbit_primitives::v1::BlockNumber> {
