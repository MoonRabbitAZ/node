...
//! Utilities for general error handling in moonrabbit.
//!
//! Goals:
//!
...
/// use moonrabbit_node_subsystem_util::{Fault, runtime};
///
/// #[derive(Debug, Error)]
/// #[error(transparent)]
...
/// ```no_run
/// # use thiserror::Error;
/// # use moonrabbit_node_subsystem_util::{Fault, unwrap_non_fatal};
/// # use moonrabbit_node_subsystem::SubsystemError;
/// # #[derive(Error, Debug)]
/// # enum Fatal {
/// # }
/// # #[derive(Error, Debug)]
