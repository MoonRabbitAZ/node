...
use moonrabbit_primitives::v1::{Hash, SignedAvailabilityBitfield, SigningContext, ValidatorId};
use moonrabbit_node_network_protocol::{v1 as protocol_v1, PeerId, View, UnifiedReputationChange as Rep, OurView};
...
mod test {
	...
	use maplit::hashmap;
	use moonrabbit_primitives::v1::{Signed, AvailabilityBitfield, ValidatorIndex};
	...
	use moonrabbit_node_network_protocol::{view, ObservedRole, our_view};
