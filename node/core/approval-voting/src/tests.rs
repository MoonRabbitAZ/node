...
use super::*;
use moonrabbit_primitives::v1::{CoreIndex, GroupIndex, ValidatorSignature};
...
where
	Compute: Fn() -> HashMap<moonrabbit_primitives::v1::CoreIndex, criteria::OurAssignment>,
...
impl<F> MockAssignmentCriteria<
	fn() -> HashMap<moonrabbit_primitives::v1::CoreIndex, criteria::OurAssignment>,
	F,
> {
