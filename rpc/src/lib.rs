...
//! moonrabbit-specific RPCs implementation.

#![warn(missing_docs)]

use std::sync::Arc;

use moonrabbit_primitives::v0::{Block, BlockNumber, AccountId, Nonce, Balance, Hash};
...
pub fn create_full<C, P, SC, B, BS>(deps: FullDeps<C, P, SC, B, BS>) -> RpcExtension where
	...
	BS: Clone + Send + moonrabbit_scale_codec::Encode + 'static,
{
