...
//! The moonrabbit runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
use moonrabbit_runtime_parachains::configuration as parachains_configuration;
use moonrabbit_runtime_parachains::shared as parachains_shared;
use moonrabbit_runtime_parachains::inclusion as parachains_inclusion;
use moonrabbit_runtime_parachains::paras_inherent as parachains_paras_inherent;
use moonrabbit_runtime_parachains::initializer as parachains_initializer;
use moonrabbit_runtime_parachains::session_info as parachains_session_info;
use moonrabbit_runtime_parachains::paras as parachains_paras;
use moonrabbit_runtime_parachains::dmp as parachains_dmp;
use moonrabbit_runtime_parachains::ump as parachains_ump;
use moonrabbit_runtime_parachains::hrmp as parachains_hrmp;
use moonrabbit_runtime_parachains::scheduler as parachains_scheduler;
use moonrabbit_runtime_parachains::runtime_api_impl::v1 as runtime_impl;
...
use moonrabbit_runtime_parachains::reward_points::RewardValidatorsWithEraPoints;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("moonrabbit-test-runtime"),
	impl_name: create_runtime_str!("moonrabbit-moonrabbit-test-runtime"),
	authoring_version: 2,
	spec_version: 1056,
	impl_version: 0,
...
sp_api::impl_runtime_apis! {
	...
	impl babe_primitives::BabeApi<Block> for Runtime {
		fn configuration() -> babe_primitives::BabeGenesisConfiguration {
			...
			// <https://research.web3.foundation/en/latest/moonrabbit/BABE/Babe/#6-practical-results>
